...
var suggestionsTemplate = '{{#suggestions}}' + '<div>' + '{{^tag}}' + '{{#category}}' + '<a href="/category/{{name}}?cid={{id}}&search={{name}}">' + '<p>{{name}} in <span class="highlight">{{category}}</span></p>' + '</a>' + '{{/category}}' + '{{^category}}' + '<a href="/search?search={{name}}">' + '<p>{{name}} in <span class="highlight">All categories</span></p>' + '</a>' + '{{/category}}' + '{{/tag}}' + '{{#tag}}' + '<a href="/?tag={{name}}">' + '<p>#{{name}}</p>' + '</a>' + '{{/tag}}' + '</div>' + '{{/suggestions}}';
...
},{"./utils/utils":7,"bloodhound":8,"jquery":13,"mustache":9,"typeahead":10}],5:[function(require,module,exports){
'use strict';
...
Slider.prototype.bindEvents = function () {
  ...
  this.$slider.on('mouseover', this.pause.bind(this)).on('mouseout', this.play.bind(this));
...
var $ = require('jquery');
var utils = require('./utils/utils');
var swapTemplate = '<div class="swapFields">' + '<textarea name="message" id="" class="small" cols="30" rows="10" placeholder="Leave a message for the owner"></textarea>' + '<input type="submit" value="Send swap request" class="btn js-submit-swapRequest" disabled>' + '</div>' + '<h3 class="ml10 mr10">Select one or more items to create swap proposition</h3>' + '{{#items}}' + '<label for="{{id}}" data-item-id="{{id}}" class="item item--inSwapList">' + ' <div class="img-container">' + '{{#firstImage}}' + '<img src="http://res.cloudinary.com/di42acdz9/image/upload/{{id}}" alt="">' + '{{/firstImage}}' + '</div>' + '<div class="item-content">' + '<h4 class="item-title">{{name}}</h4>' + '<p class="item-tag-title">' + '<b>Tags:&nbsp;' + '{{#tags}}' + '<a href="/tag/{{tag.name}}">' + '#{{name}}&#32;' + '</a>' + '{{/tags}}' + '</b>' + ' </p>' + '</div>' + '<input type="checkbox" id="{{id}}" name="itemId" value="{{id}}" class="selectItem">' + '</label> {{/items}}';
...
},{"./utils/utils":7,"jquery":13,"mustache":9}],7:[function(require,module,exports){
'use strict';
...
module.exports = {
  ...
  gatherFormData: function gatherFormData($form) {
    var formData = {};
...
},{"../components/Counter":1,"../components/FormValidator":2,"../components/Menu":3,"../components/Search":4,"../components/utils/utils":7,"jquery":13}],12:[function(require,module,exports){
'use strict';
...
},{"../components/Slider":5,"../components/SwapRequestForm":6,"../components/utils/utils":7,"jquery":13}],13:[function(require,module,exports){
/*!
