...
var messageTemplate = '<div class="paperStyle pl30 pr30 pt25 pb25 {{#message.senderName}}mr30{{/message.senderName}}{{^message.senderName}}ml30{{/message.senderName}} mb20 js-message">' + '<p class="section-subtitle">' + '{{#message.senderName}}' + '{{.}}' + '{{/message.senderName}}' + '{{^message.senderName}}' + 'Me:' + '{{/message.senderName}}' + '</p>' + '<p>{{message.text}}</p>' + '</div>';
...
},{"./utils/utils":7,"mustache":9}],2:[function(require,module,exports){
'use strict';
...
},{"../components/Chat":1,"../components/SwapRequestStatusChanger":6}],13:[function(require,module,exports){
/*!
