...
},{"./templates/message.html":6,"./utils/utils":7,"mustache":8}],2:[function(require,module,exports){
'use strict';
...
},{"./utils/utils":7}],6:[function(require,module,exports){
module.exports = "<div class=\"paperStyle pl30 pr30 pt25 pb25 {{#message.senderName}}mr30{{/message.senderName}}{{^message.senderName}}ml30{{/message.senderName}} mb20 js-message\">\n  <p class=\"section-subtitle\">\n    {{#message.senderName}}\n      {{.}}\n    {{/message.senderName}}\n    {{^message.senderName}}\n      Me:\n    {{/message.senderName}}\n  </p>\n  <p>{{message.text}}</p>\n</div>\n";
...
},{"../components/Counter":2,"../components/FormValidator":3,"../components/Menu":4,"../components/utils/utils":7}],10:[function(require,module,exports){
'use strict';
...
},{"../components/Chat":1,"../components/FormValidator":3,"../components/SwapRequestStatusChanger":5}]},{},[9,10]);
